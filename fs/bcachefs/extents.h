...
int bch2_btree_ptr_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
void bch2_btree_ptr_to_text(struct bch_printbuf *, struct bch_fs *,
			    struct bkey_s_c);

int bch2_btree_ptr_v2_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
void bch2_btree_ptr_v2_to_text(struct bch_printbuf *, struct bch_fs *, struct bkey_s_c);
...
void bch2_reservation_to_text(struct bch_printbuf *, struct bch_fs *, struct bkey_s_c);
...
void bch2_bkey_ptrs_to_text(struct bch_printbuf *, struct bch_fs *,
			    struct bkey_s_c);
