...
int bch2_quota_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
void bch2_quota_to_text(struct bch_printbuf *, struct bch_fs *, struct bkey_s_c);
