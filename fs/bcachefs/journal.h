...
void __bch2_journal_debug_to_text(struct bch_printbuf *, struct journal *);
void bch2_journal_debug_to_text(struct bch_printbuf *, struct journal *);
void bch2_journal_pins_to_text(struct bch_printbuf *, struct journal *);
bool bch2_journal_seq_pins_to_text(struct bch_printbuf *, struct journal *, u64 *);
