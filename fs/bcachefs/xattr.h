...
int bch2_xattr_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
void bch2_xattr_to_text(struct bch_printbuf *, struct bch_fs *, struct bkey_s_c);
