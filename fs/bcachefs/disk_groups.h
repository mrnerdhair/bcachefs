...
void bch2_disk_path_to_text(struct bch_printbuf *, struct bch_sb *, unsigned);

int bch2_opt_target_parse(struct bch_fs *, const char *, u64 *);
void bch2_opt_target_to_text(struct bch_printbuf *, struct bch_fs *, struct bch_sb *, u64);
