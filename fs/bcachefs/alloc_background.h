...
int bch2_alloc_v1_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
int bch2_alloc_v2_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
int bch2_alloc_v3_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
int bch2_alloc_v4_invalid(const struct bch_fs *, struct bkey_s_c, int, struct bch_printbuf *);
void bch2_alloc_v4_swab(struct bkey_s);
void bch2_alloc_to_text(struct bch_printbuf *, struct bch_fs *, struct bkey_s_c);
